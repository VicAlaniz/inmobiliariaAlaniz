	...
	public class RepositorioInmueble
	{
		...
		public List<Inmueble> ObtenerTodos() {
			...
			using (var conn = new MySqlConnection(connectionString))
			{
				...
				Coordenadas, Precio, IdPropietario, p.Nombre, p.Apellido 
		...
		public int Modificacion(Inmueble inm)
		{
			...
			using (var conn = new MySqlConnection(connectionString))
			{
				...
				CantAmbientes=@cantAmbientes, Coordenadas=@coordenadas, Precio=@precio, IdPropietario=@idPropietario 
				WHERE Id = @id";
				using (var comm = new MySqlCommand(sql, conn))
				{
					comm.CommandType = System.Data.CommandType.Text;
                    ...
                    comm.Parameters.AddWithValue("@idPropietario", inm.IdPropietario);
		...
		public int Alta(Inmueble inm)
		{
			...
			using (var conn = new MySqlConnection(connectionString))
			{
				string sql = @"INSERT INTO Inmueble (Direccion, Uso, Tipo, CantAmbientes, Coordenadas, Precio, IdPropietario) 
				VALUES (@direccion, @uso, @tipo, @cantAmbientes, @coordenadas, @precio, @idPropietario);
